...
find . -name "*.md" -type f | xargs sed -i '' 's/https:\/\/raw.githubusercontent.com\/imekaku\/MyPicture\/master\/github-thinking-pic/http:\/\/blogcdn.qihope.com\/github-blog-pic/g'